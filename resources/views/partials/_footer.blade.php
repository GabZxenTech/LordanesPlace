...
<footer class="bg-warm-black border-t border-gold-deep/30 px-[5%] lg:px-[8%] pt-[60px] pb-[30px]">
  <div class="grid grid-cols-1 md:grid-cols-[2fr_1fr] gap-10 md:gap-[60px] mb-10">
    <div>
      <h3 class="font-heading text-[24px] text-gold-deep mb-3.5">LorDane's Place</h3>
      ...
      <div class="flex items-center gap-4">
        <a href="https://www.facebook.com/LorDanesPlace" target="_blank" rel="noopener noreferrer" class="w-11 h-11 rounded-full border border-gold-deep/30 flex items-center justify-center text-off-white/70 hover:bg-gold-deep hover:text-warm-black hover:border-gold-deep transition-all duration-300">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
            <path fill-rule="evenodd" d="M22 12c0-5.523-4.477-10-10-10S2 6.477 2 12c0 4.991 3.657 9.128 8.438 9.878v-6.987h-2.54V12h2.54V9.797c0-2.506 1.492-3.89 3.777-3.89 1.094 0 2.238.195 2.238.195v2.46h-1.26c-1.243 0-1.63.771-1.63 1.562V12h2.773l-.443 2.89h-2.33v6.988C18.343 21.128 22 16.991 22 12z" clip-rule="evenodd" />
          </svg>
        </a>
        <a href="#" target="_blank" rel="noopener noreferrer" class="w-11 h-11 rounded-full border border-gold-deep/30 flex items-center justify-center text-off-white/70 hover:bg-gold-deep hover:text-warm-black hover:border-gold-deep transition-all duration-300">
          <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
